...
import {Encrypt} from '../../auth/core/_requests'
import Loader from '../../../pages/loader/Loader'

const SORT_ASC = 'asc'
const SORT_DESC = 'desc'

const EmployeeDataTable = (props: any) => {
  const intl = useIntl()
...
//@ts-ignore
export default connect((state) => ({user: state.user}))(EmployeeDataTable)
