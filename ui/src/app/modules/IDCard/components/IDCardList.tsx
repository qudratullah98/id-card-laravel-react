...
import IDCardDataTable from './IDCardDataTable'

const IDCardList = (props: any) => {
  const intl = useIntl()
          ...
          <div className='d-flex align-items-center py-1'>
            ...
            {props.user.userCan('create-card') ? (
              ...
              >
                ...
                {intl.formatMessage({id: 'CARD.NEW_CARD'})}
              </Link>
            ) : (
              ''
            )}
...
//@ts-ignore
export default connect((state) => ({user: state.user}))(IDCardList)
